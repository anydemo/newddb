...
clone raftexample and add some new code, just for leanning raft

newddb is an example usage of etcd's [raft library](https://go.etcd.io/etcd). It provides a simple REST API for a key-value store cluster backed by the [Raft][raft] consensus algorithm.
